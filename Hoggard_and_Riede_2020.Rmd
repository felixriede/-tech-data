...
fviz_screeplot(blade_pca, xlim = c(1,5), ylim = c(0,50), barfill = "grey50", barcolor = "grey50", geom = "bar") +
...
ggplot(bp_data_excb_clean, aes(TCSA, TCSP, colour = CODE, shape = CODE)) +
  ...
  lims(x = c(0,100), y = c(0,50)) +
  theme_minimal() + 
  scale_colour_manual(values = c("grey90", "grey70", "grey50", "grey30", "grey20", "grey10")) +
...
fviz_pca_biplot(bp_excb_pca, 
                ...
                palette = c("grey80", "grey70", "grey60", "grey50", "grey40", "grey30"),
                label = "var",
                addEllipses = TRUE) +
...
ggplot(tp_data_excb_clean, aes(TCSA, TCSP, colour = CODE, shape = CODE)) +
  ...
  lims(x = c(0,75), y = c(0,40)) +
  theme_minimal() + 
  scale_colour_manual(values = c("grey90", "grey70", "grey50", "grey30", "grey10")) +
  scale_shape_manual(values = c(1,2,3,4,5)) +
  theme(legend.position = "bottom")
